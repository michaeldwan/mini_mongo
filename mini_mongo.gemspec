...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/mini_mongo/document/dirty.rb",
    "lib/mini_mongo/document/modifications.rb",
    "lib/mini_mongo/document/persistance.rb",
    "lib/mini_mongo/document/validation_errors.rb",
